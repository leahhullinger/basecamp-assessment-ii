...
var myFriends = ['Alexa','Nicole','Ann','Laura']
// #6 Add a fifth friends name to the end of your myFriends array

myFriends.splice(4,0,"Martha");
...
var evensOnly = function(){
  for(i=0;i<myNumbers.length;i++){
    if(myNumbers[i] === 0 ){evensArray.push(myNumbers[i])
    }
    else if(myNumbers[i] % 2 === 0){evensArray.push(myNumbers[i])
    }
...
let indexes = [];
var indexFinder = randomNumbers.map(function(num,i){
  indexes.push(i)
})
